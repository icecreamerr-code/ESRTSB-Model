...
RAW_DIR = '../ESRTSB-data/PHP/'
FEATENG_DIR = '../ESRTSB-data/PHP/feateng/'
...
if __name__ == "__main__":
    ...
    process_social(RAW_DIR + 'PHP.csv',RAW_DIR+'PHP_filterd.csv')
    preprocess_raw_data(RAW_DIR + 'PHP_filterd.csv', FEATENG_DIR + 'remaped_user_behavior.csv', FEATENG_DIR + 'remap_dict.pkl', FEATENG_DIR + 'time_distri.png', FEATENG_DIR + 'user_feat_dict.pkl', FEATENG_DIR + 'item_feat_dict.pkl')
