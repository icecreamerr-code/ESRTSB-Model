...
RAW_DIR = '../ESRTSB-data/JavaScript/'
FEATENG_DIR = '../ESRTSB-data/JavaScript/feateng/'

START_TIME = 1400668490
END_TIME = 1432204490
TIME_DELTA = 14 * 24 * 3600
...
if __name__ == "__main__":
    ...
    process_social(RAW_DIR + 'JavaScript.csv',RAW_DIR+'JavaScript_filterd.csv')
    preprocess_raw_data(RAW_DIR + 'JavaScript_filterd.csv', FEATENG_DIR + 'remaped_user_behavior.csv', FEATENG_DIR + 'remap_dict.pkl', FEATENG_DIR + 'time_distri.png', FEATENG_DIR + 'user_feat_dict.pkl', FEATENG_DIR + 'item_feat_dict.pkl')
